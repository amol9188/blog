            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form method="GET" action="<?php echo e(url('/admin/posts')); ?>" accept-charset="UTF-8" class="navbar-form navbar-right" role="search">
                            ...
                            <table class="table table-borderless">
                                ...
                                <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($item->title); ?></td><td><?php echo e($item->body); ?></td>
                                        <td>
                                            ...
                                            <form method="POST" action="<?php echo e(url('/admin/posts' . '/' . $item->id)); ?>" accept-charset="UTF-8" style="display:inline">
